...
/*
Package hatch_userservice is a generated twirp stub package.
...
func (c *userServiceProtobufClient) GetUser(ctx context.Context, in *UserId) (*User, error) {
	ctx = ctxsetters.WithPackageName(ctx, "hatch.userservice")
...
const UserServicePathPrefix = "/twirp/hatch.userservice.UserService/"
...
func (s *userServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/hatch.userservice.UserService/GetUser":
